...
function main() {
  ...
  const requiredUi = ["Unknown material is queued to an AI Work Order before it can reach Intake", "Create AI Work Order", "Create Large-file/folder AI Work Order", "Start local AI digestion from AI Work Orders", "Editable source/work-order label", "async function createDiscoveryAiWorkOrders"];
  ...
  assert(app.includes("Confirming creates the Work Order") && app.includes("Create Large-file/folder AI Work Order"), "Discovery should route AI follow-up to AI Work Orders instead of running it inline.");
