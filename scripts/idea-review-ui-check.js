...
function main() {
  ...
  const requiredUi = ["function renderIdeaCandidateReview", "function runFakeIdeaAnalysis", "Run local AI idea analysis", "Qwen3 8B is installed", "Evidence and provenance", "Confirm idea review", "Confirmed Idea Unit", "Working file-based name, only if treated as one item", "platformAdapter.analysis.recordReviewDecision"];
